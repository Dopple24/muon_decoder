...
## Licence
The source code of this application is licensed under the *GPL-3.0* licence.  
All graphics, including the main particle image, generated by this app is licensed under the *CC BY 4.0* licence.  
Any use of said imagery requires attribution to the authors in a format similiar to:  
*Image generated by the [particle_decoder](https://github.com/Dopple24/muon_decoder) application by [Radek Roub](https://github.com/Dopple24). Licensed under CC BY 4.0*
